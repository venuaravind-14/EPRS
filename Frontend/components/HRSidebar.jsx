...
const menuItems = [
  { text: "Dashboard", icon: <DashboardIcon />, path: "/hr", notification: 0 },
  { text: "Department", icon: <DomainIcon />, path: "/hr/department", notification: 0 },
  { text: "Team", icon: <Diversity3Icon />, path: "/hr/team", notification: 0 },
