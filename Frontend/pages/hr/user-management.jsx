    ...
    try {
      ...
      const usersWithDetails = (response.data || []).map((user) => {
        ...
        if (user.role === "manager") {
          const departmentId = user.managerDetails?.department?._id || user.managerDetails?.department;
          const department = (departments || []).find(d => d && d._id === departmentId);
          return {
            ...user,
            managerDetails: {
              ...(user.managerDetails || {}),
        ...
        if (user.role === "employee" && user.employeeDetails?.department) {
          const departmentId = user.employeeDetails.department?._id || user.employeeDetails.department;
          const department = (departments || []).find(d => d && d._id === departmentId);
          return {
            ...user,
            employeeDetails: {
